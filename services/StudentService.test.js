...
describe("StudentService Unit Testing", ()=>{
    test('1) getStudents method: Gets all students', () => { 
     ...
     test('2) getCertifiedStudents method: Returns certified students', ()=>{
       expect(StudentService.getCertifiedStudents([
        {
          "id": "6264d5d89f1df827eb84bb23",
          "name": "Warren",
          "email": "Todd@visualpartnership.xyz",
     ...
     test("3) getGoodStudents method: that have score above 500", ()=>{
       expect(StudentService.getGoodStudents([
        {
          "id": "6264d5d89f1df827eb84bb23",
          "name": "Warren",
          "email": "Todd@visualpartnership.xyz",
